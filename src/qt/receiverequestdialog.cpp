...
#include <config/bitcoinsn-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcoinSNURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + BitcoinSNUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitcoinSNURI(info));
}
