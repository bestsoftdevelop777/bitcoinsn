BitcoinSN-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinsn/files/BitcoinSN/bitcoinsn-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinSN
...
New/changed settings (command-line or bitcoinsn.conf file)
--------------------------------------------------------
