BitcoinSN Core version 0.9.4 is now available from:

  https://bitcoinsn.org/bin/0.9.4/
...
this update is incompatible with the BitcoinSN system and could lead to consensus
forks.

BitcoinSN Core released binaries from https://bitcoinsn.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinsn/+archive/ubuntu/bitcoinsn
- A third-party or self-compiled BitcoinSN Core

upgrade to BitcoinSN Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
