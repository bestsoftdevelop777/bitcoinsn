Download URL: https://sourceforge.net/projects/bitcoinsn/files/BitcoinSN/bitcoinsn-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BSN fee schedule (users still pay 0.01 BSN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinsn00 - #bitcoinsn99
