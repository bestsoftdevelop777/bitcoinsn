...
"""Verify that starting bitcoinsn with -h works as expected."""

from test_framework.test_framework import BitcoinSNTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinSNTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinsn with -h for help text")
        ...
        self.log.info("Start bitcoinsn with -version for version information")
        ...
        self.log.info("Start bitcoinsnd with -fakearg to make sure it does not start")
