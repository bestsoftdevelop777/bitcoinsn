                                                                   ...
                                                                   mapper(0)
{
    ...
    ui->bitcoinsnAtStartup->setToolTip(ui->bitcoinsnAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinsnAtStartup->setText(ui->bitcoinsnAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinSNConfButton->setToolTip(ui->openBitcoinSNConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinSNUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinsnAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinSNConfButton_clicked()
{
