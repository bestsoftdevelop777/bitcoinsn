...
#ifndef BITCOINSN_WALLET_WALLETDB_H
#define BITCOINSN_WALLET_WALLETDB_H
...
public:
    explicit WalletBatch(WalletDatabase& database, const char* pszMode = "r+", bool _fFlushOnClose = true) : m_batch(database, pszMode, _fFlushOnClose),
                                                                                                             m_database(database)
    {
    }
...
#endif // BITCOINSN_WALLET_WALLETDB_H
