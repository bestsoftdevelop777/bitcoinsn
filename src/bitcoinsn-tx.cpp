...
static void SetupBitcoinSNTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinsn-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  bitcoinsn-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinsn transaction\n" +
                               "or:     bitcoinsn-tx [options] -create [commands]   Create hex-encoded bitcoinsn transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinsn transaction
