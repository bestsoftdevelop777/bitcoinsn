...
#ifndef BITCOINSN_CONSENSUS_CONSENSUS_H
#define BITCOINSN_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinSN parameters, but if this fork is a fork
...
#define select_activation_height(height) (height > FORK_BLOCK ? 1 + FORK_BLOCK + (!FORK_BLOCK) : height)
...
#endif // BITCOINSN_CONSENSUS_CONSENSUS_H
