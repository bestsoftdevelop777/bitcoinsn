BitcoinSN Core version 0.10.4 is now available from:

  <https://bitcoinsn.org/bin/bitcoinsn-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinsn-tx into its own package
- #6953 `dfe0d4d` Include bitcoinsn-tx binary on Debian/Ubuntu
