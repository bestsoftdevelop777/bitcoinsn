...
#ifndef BITCOINSN_WALLET_COINSELECTION_H
#define BITCOINSN_WALLET_COINSELECTION_H
...
struct OutputGroup {
    ...
    OutputGroup(std::vector<CInputCoin>&& outputs, bool from_me, CAmount value, int depth, size_t ancestors, size_t descendants)
        : m_outputs(std::move(outputs)), m_from_me(from_me), m_value(value), m_depth(depth), m_ancestors(ancestors), m_descendants(descendants)
    {
    }
...
#endif // BITCOINSN_WALLET_COINSELECTION_H
