...
# TestP2PConn: A peer we use to send messages to bitcoinsnd, and store responses.
...
class CompactBlocksTest(BitcoinSNTestFramework):
    ...
    # This test actually causes bitcoinsnd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitcoinsnd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinsnd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinsnd will not send blocktxn responses for blocks whose height is
