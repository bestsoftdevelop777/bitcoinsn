...
#ifndef BITCOINSN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINSN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINSN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
