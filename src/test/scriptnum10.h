...
#ifndef BITCOINSN_TEST_SCRIPTNUM10_H
#define BITCOINSN_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinSN Core 0.10.0, for cross-comparison.
 */
public:
