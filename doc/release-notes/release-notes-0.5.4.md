BitcoinSN version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinsn/files/BitcoinSN/bitcoinsn-0.5.4/
...
http://gitorious.org/bitcoinsn/bitcoinsnd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinSN-Qt notifications under Growl 1.3.
Increase required age of BitcoinSN-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinSN properly when installing BitcoinSN-Qt over it. (Windows)
