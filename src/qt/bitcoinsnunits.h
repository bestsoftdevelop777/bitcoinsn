...
#ifndef BITCOINSN_QT_BITCOINSNUNITS_H
#define BITCOINSN_QT_BITCOINSNUNITS_H
...
/** BitcoinSN unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinSNUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinSNUnits(QObject* parent);

    /** BitcoinSN units.
      @note Source: https://en.bitcoinsn.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        BSN,
        mBSN,
...
typedef BitcoinSNUnits::Unit BitcoinSNUnit;

#endif // BITCOINSN_QT_BITCOINSNUNITS_H
