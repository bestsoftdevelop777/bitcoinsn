...
#ifndef BITCOINSN_WALLET_WALLET_H
#define BITCOINSN_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinsn node, and set to 0 for transactions that were created
...
public:
     ...
     */
    bool SelectCoins(const std::vector<COutput>& vAvailableCoins, const CAmount& nTargetValue, std::set<CInputCoin>& setCoinsRet, CAmount& nValueRet, const CCoinControl& coin_control, CoinSelectionParams& coin_selection_params, bool& bnb_used) const;
...
#endif // BITCOINSN_WALLET_WALLET_H
