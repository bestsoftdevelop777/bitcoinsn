 ...
 */
#ifndef BITCOINSN_UTIL_H
#define BITCOINSN_UTIL_H
...
extern const char* const BITCOINSN_CONF_FILENAME;
extern const char* const BITCOINSN_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinsn-%s", name);
