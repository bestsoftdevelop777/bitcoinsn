BitcoinSN Core version 0.9.2.1 is now available from:

  https://bitcoinsn.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BSN to 0.01 BSN
...
- Fix "Start bitcoinsn on system login"
