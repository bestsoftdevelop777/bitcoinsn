BitcoinSN Core version 0.16.1 is now available from:

  <https://bitcoinsncore.org/bin/bitcoinsn-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoinsnd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoinsnd processes are cleaned up when tests end (sdaftuar)
