BitcoinSN Core version 0.10.3 is now available from:

  <https://bitcoinsn.org/bin/bitcoinsn-core-0.10.3/>
...
(see https://github.com/bitcoinsn/bitcoinsn/pull/6793, as well as the 0.11.0
