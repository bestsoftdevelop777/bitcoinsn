BitcoinSN Core version 0.13.2 is now available from:

  <https://bitcoinsn.org/bin/bitcoinsn-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinsn-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinsn-tx to create v2 transactions (btcdrak)
