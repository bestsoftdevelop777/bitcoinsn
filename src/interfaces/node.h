...
#ifndef BITCOINSN_INTERFACES_NODE_H
#define BITCOINSN_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinsn node (bitcoinsnd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINSN_INTERFACES_NODE_H
