...
#ifndef BITCOINSN_WALLET_DB_H
#define BITCOINSN_WALLET_DB_H
...
public:
    ...
    BerkeleyDatabase(const fs::path& wallet_path, bool mock = false) : nUpdateCounter(0), nLastSeen(0), nLastFlushed(0), nLastWalletUpdate(0)
    {
